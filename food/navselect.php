...
<?php include("include/main_header.php"); ?>
  ...
  <div class="row">
    ...
    $cate=$_GET['category'];
    $query1="select * from product where  category='$cate'";
...
<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="height:300px;"onClick="productclicked('<?php echo $name?>')" >
...
<center>  <span style="font-size:20px;font-family:sans-sarif;"><b><?php echo $row1['name']; ?></b></span></center>
   </div>
