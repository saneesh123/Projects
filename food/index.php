...
.active{
  background-color:rgba(238, 195, 39, 0.9);
  color:black;
}
...
.modal-backdrop {
  ...
  <body style="margin:0px;padding:0px">
    ...
    <?php
    if($_SESSION['user']!=""){
      include("include/login_navbar.php");
    }else{
...
<div class="modal fade " id="login" >
  <div class="modal-dialog" style="background-color:white;color:black;height:50%;" >
    <div class="model-content">
      <div class="modal-header" style="border-bottom:2px solid orange;">
...
<div class="modal-dialog" style="background-color:white;color:black;height:60%;">
  <div class="model-content">
    <div class="modal-header" style="border-bottom:2px solid orange;">
      <button type="button" class="close" data-dismiss="modal" name="button">&times;</button>
...
<div class="container-fluid">
  ...
  ?>
      ...
      <div class="top" style="color:rgb(36, 11, 1);margin-left:-5px"><center><h4><?php echo $name;?></h4></center></div>
        ...
        <div class="bottom-center">
          ...
          <button type="button" name="minus" class="btn btn-primary btn-xs" id="<?php echo $btnid; ?>" onClick='decrement("<?php echo $cnt;?>","<?php echo $btnid; ?>")'disabled><i class="glyphicon glyphicon-minus"></i></button>
          <span style="width:25px;height:30px;font-size:15px;" id="<?php echo $cnt; ?>"><b>1</b></span>
        ...
        <div class="bottom-right"><i class="fa fa-shopping-cart fa-2x" aria-hidden="true" style="color:rgba(38, 76, 237, 1);padding-right:10px;padding-bottom:10px;" onClick="addcart('<?php echo $cnt; ?>','<?php echo $name; ?>')"></i></div>
  ...
  <?php }else{
//echo "inside else category=".$category;
$result5=mysqli_query($bd,"select * from category where cid='$category'");
$row5=mysqli_fetch_array($result5);
$cate=$row5['categoryname'];
//echo $cate;
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <?php $query1="select * from items where category='$cate'";
              $result1=mysqli_query($bd,$query1);
              $cnt=1000;
